...
public class PartList {
	...
	public PartList() {												
		...
		motherboards.add(new MotherboardPart("Asus", "M5A97 R2.0", "AM3+", "", 94.99, 1));
		motherboards.add(new MotherboardPart("MSI", "X99A GODlike Gaming", "LGA 2011-v3", "", 539.99, 1));
		motherboards.add(new MotherboardPart("GIGABYTE", "GA-B85M-DS3H-A", "LGA 1150", "", 49.99, 1));
		motherboards.add(new MotherboardPart("ASRock", "Z170 Pro4s", "LGA 1151", "", 109.99, 1));
		

		
		gpus.add(new GpuPart("GIGABYTE", "GV-N970XTREME-4GD", "PCI Express 3.0 x16", "GeForce GTX 970", "4", "", 379.99, 1));
		gpus.add(new GpuPart("XFX", "R7-250X-CGF4", "PCI Express 3.0 x16", "Radeon R7 250X", "2", "", 89.99, 1));
		gpus.add(new GpuPart("EVGA", "06G-P4-4996-KR", "PCI Express 3.0 x16", "GeForce GTX 980 Ti", "6", "", 659.99, 1));
		
		gpus.get(0).setPrice(379.99);
		gpus.get(1).setPrice(89.99);
		gpus.get(2).setPrice(659.99);
		
		rams.add(new RamPart("CORSAIR", "Vengeance Pro", "CMY16GX3M2A1866C9R", "16", "DDR3", "Dual", "", 69.99, 1));
		rams.add(new RamPart("G.SKILL", "Ripjaws Z Series", "F3-17000CL11Q2-64GBZLD", "64", "DDR3", "Quad", "", 346.99, 1));
		rams.add(new RamPart("HyperX", "FURY", "HX421C14FBK2/8", "8", "DDR4", "none", "", 79.95, 1));
